...
knn_index_dist_rcpp <- function(MATRIX, TEST_DATA, k, method, threads, p, eps = 1.0e-6) {
    .Call(`_KernelKnn_knn_index_dist_rcpp`, MATRIX, TEST_DATA, k, method, threads, p, eps)
}
